...
public final class DateUtil {
    ...
    public static boolean verifyCreated(
        ...
        System.out.println("WSS4J_DEBUG: Inside verify created...");

        System.out.println("WSS4J_DEBUG: TTL:  " + timeToLive + "  FTL:  " + futureTimeToLive);
        ...
        if (createdDate.after(validCreation)) {
            System.out.println("WSS4J_DEBUG: The message was created in the future!");
        ...
        System.out.println("WSS4J_DEBUG: Date Created: " + createdDate);

        System.out.println("WSS4J_DEBUG: Validation date: " + validCreation);

        // Validate the time it took the message to travel
        if (createdDate.before(validCreation)) {
            System.out.println("WSS4J_DEBUG: The message was created too long ago");
            if (LOG.isDebugEnabled()) {
